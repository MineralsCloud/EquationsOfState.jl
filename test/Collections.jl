...
@testset "Test EOS promotion" begin
    ...
    @test BirchMurnaghan2nd(1 // 1, Int32(2), 0) == BirchMurnaghan2nd{Rational{Int}}(1 // 1, 2 // 1, 0 // 1)
    @test BirchMurnaghan3rd(Int8(1), 2, 4, 0) == BirchMurnaghan3rd{Int}(1, 2, 4, 0)
    @test BirchMurnaghan3rd(Int8(1), 2 // 1, 4, 0) == BirchMurnaghan3rd{Rational{Int}}(1 // 1, 2 // 1, 4 // 1, 0 // 1)
    @test BirchMurnaghan4th(Int8(1), 2, 4, Int16(5), 6) == BirchMurnaghan4th{Int}(1, 2, 4, 5, 6)
    @test BirchMurnaghan4th(Int8(1), 2 // 1, 4, Int16(5), 6) == BirchMurnaghan4th{Rational{Int}}(
        1 // 1,
        2 // 1,
        4 // 1,
        5 // 1,
    ...
    @test PoirierTarantola3rd(Int8(1), 2 // 1, 3 // 1, Int16(4)) == PoirierTarantola3rd{Rational{Int}}(
        1 // 1,
        2 // 1,
        3 // 1,
        4 // 1,
    )
    @test PoirierTarantola4th(Int8(1), 2, 3, Int16(4), 5) == PoirierTarantola4th{Int}(1, 2, 3, 4, 5)
    @test PoirierTarantola4th(Int8(1), 2 // 1, 3, Int16(4), 5) == PoirierTarantola4th{Rational{Int}}(
        1 // 1,
        2 // 1,
        3 // 1,
        4 // 1,
    ...
    @test Vinet(Int8(1), 2 // 1, 3, Int16(4)) == Vinet{Rational{Int}}(1 // 1, 2 // 1, 3 // 1, 4 // 1)
    @test AntonSchmidt(Int8(1), 2, 3, 0) == AntonSchmidt{Int}(1, 2, 3, 0)
    @test AntonSchmidt(Int8(1), 2 // 1, 3, 0) == AntonSchmidt{Rational{Int}}(1 // 1, 2 // 1, 3 // 1, 0 // 1)
    @test BreenanStacey(1, 2, 3, 0) == BreenanStacey{Int}(1, 2, 3, 0)
    @test BreenanStacey(1, 2, 3 // 1, 0) == BreenanStacey{Rational{Int}}(1 // 1, 2 // 1, 3 // 1, 0 // 1)
    ...
    @test typeof(PoirierTarantola2nd(1u"nm^3", 2u"GPa", 3.0u"eV")) == PoirierTarantola2nd{Quantity{Float64}}
    @test typeof(PoirierTarantola2nd(
        1u"nm^3",
        2u"GPa",
        3 // 1u"eV",
    )) == PoirierTarantola2nd{Quantity{Rational{Int}}}
    @test typeof(PoirierTarantola3rd(1u"nm^3", 2u"GPa", 3, 4.0u"eV")) == PoirierTarantola3rd{Quantity{Float64}}
    ...
    @test typeof(Vinet(1u"nm^3", 2u"GPa", 3, 4 // 1u"eV")) == Vinet{Quantity{Rational{Int}}}
    @test typeof(AntonSchmidt(1u"nm^3", 2u"GPa", 3.0, 0u"eV")) == AntonSchmidt{Quantity{Float64}}
    @test typeof(AntonSchmidt(1u"nm^3", 2u"GPa", 3 // 1, 0u"eV")) == AntonSchmidt{Quantity{Rational{Int}}}
    @test typeof(BreenanStacey(1u"nm^3", 2u"GPa", 3.0, 0u"eV")) == BreenanStacey{Quantity{Float64}}
    @test typeof(BreenanStacey(1u"nm^3", 2u"GPa", 3 // 1, 0u"eV")) == BreenanStacey{Quantity{Rational{Int}}}
end
...
@testset "Test default EOS parameter `e0` and promotion" begin
    ...
    @test typeof(BirchMurnaghan2nd(1u"nm^3", 2.0u"GPa")) == BirchMurnaghan2nd{Quantity{Float64}}
    @test typeof(BirchMurnaghan3rd(1u"nm^3", 2u"GPa", 4)) == BirchMurnaghan3rd{Quantity{Int}}
    @test typeof(BirchMurnaghan3rd(1u"nm^3", 2u"GPa", 4.0)) == BirchMurnaghan3rd{Quantity{Float64}}
    @test typeof(BirchMurnaghan4th(1u"nm^3", 2u"GPa", 3, 4u"1/GPa")) == BirchMurnaghan4th{Quantity{Int}}
    @test typeof(BirchMurnaghan4th(1u"nm^3", 2u"GPa", 3, 4.0u"1/GPa")) == BirchMurnaghan4th{Quantity{Float64}}
    @test typeof(PoirierTarantola2nd(1u"nm^3", 2u"GPa")) == PoirierTarantola2nd{Quantity{Int}}
    @test typeof(PoirierTarantola2nd(1u"nm^3", 2.0u"GPa")) == PoirierTarantola2nd{Quantity{Float64}}
    @test typeof(PoirierTarantola3rd(1u"nm^3", 2u"GPa", 3)) == PoirierTarantola3rd{Quantity{Int}}
    @test typeof(PoirierTarantola3rd(1u"nm^3", 2u"GPa", 3.0)) == PoirierTarantola3rd{Quantity{Float64}}
    @test typeof(PoirierTarantola4th(1u"nm^3", 2u"GPa", 3, 4u"1/GPa")) == PoirierTarantola4th{Quantity{Int}}
    @test typeof(PoirierTarantola4th(
        1u"nm^3",
        2u"GPa",
        3,
